              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                {telegramStatus?.linked ? (
                  ...
                  <button
                    ...
                    className="px-6 py-3.5 bg-[#229ED9] hover:bg-[#1e8bc0] text-white text-sm font-bold uppercase tracking-widest rounded-lg inline-flex items-center justify-center gap-2.5 transition-all shadow-md active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer whitespace-nowrap"
                  ...
                  >
                    ...
                    <span>{isLinkingTelegram ? 'Waiting for Telegram…' : 'Link Telegram'}</span>
                  </button>
                )}
              </div>
